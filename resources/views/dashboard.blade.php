            ...
            <section class="mt-6 card paper-grain">
                <div class="p-6 sm:p-8">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <a href="{{ route('livros.index') }}" class="group flex items-center gap-4 p-4 bg-paper-light border border-line hover:border-brass/50 hover:bg-brass/5 transition-colors rounded-[3px]">
                        ...
                        <a href="{{ route('emprestimos.index') }}" class="group flex items-center gap-4 p-4 bg-paper-light border border-line hover:border-brass/50 hover:bg-brass/5 transition-colors rounded-[3px]">
                        ...
                        <a href="{{ route('salas.index') }}" class="group flex items-center gap-4 p-4 bg-paper-light border border-line hover:border-brass/50 hover:bg-brass/5 transition-colors rounded-[3px]">
                        ...
                        <a href="{{ route('reservas.index') }}" class="group flex items-center gap-4 p-4 bg-paper-light border border-line hover:border-brass/50 hover:bg-brass/5 transition-colors rounded-[3px]">
                            <div class="w-11 h-11 rounded bg-leather/10 border border-leather/20 flex items-center justify-center group-hover:bg-leather/15 transition-colors">
                                <svg class="w-6 h-6 text-leather" fill="none" stroke="currentColor" viewBox="0 0 24 24">
